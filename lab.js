...
if (amysAge > brittanisAge) {
  console.log("Amy's age is older.")
} else if (amysAge < brittanisAge) {
  console.log("Brittanis' age is older")
} else {
...
if (amysBirthYear > brittanisBirthYear) {
  console.log("Brittanis was born before Amy.")
} else if (amysBirthYear < brittanisBirthYear) {
  console.log("Amy was born before Brittanis.")
} else {
  console.log("They were born on the same year.")
}
...
// Now, use an if statement to help make sure you have the correct amount of elements, and then reset your variable, 'problem9' to the value of the 7th element in the array.
